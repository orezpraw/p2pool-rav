...
nets = dict(
    ...
    dogecointestnet=math.Object(
        PARENT=networks.nets['dogecointestnet'],
        SHARE_PERIOD=15, # seconds target spacing
        CHAIN_LENGTH=12*60*60//15, # shares
        REAL_CHAIN_LENGTH=12*60*60//15, # shares
        TARGET_LOOKBEHIND=20, # shares coinbase maturity
        SPREAD=10, # blocks
        IDENTIFIER='cca5e24ec6408b1f'.decode('hex'),
        PREFIX='ad9614f6466a39d0'.decode('hex'),
        P2P_PORT=8556,
        MIN_TARGET=0,
        MAX_TARGET=2**256//2**20 - 1,
        PERSIST=False,
        WORKER_PORT=9556,
        BOOTSTRAP_ADDRS='wza.us'.split(' '),
        ANNOUNCE_CHANNEL='#p2pool-alt',
        VERSION_CHECK=lambda v: True,
    ),
